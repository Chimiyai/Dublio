...
interface DubbedSectionProps {
  ...
  swiperClassName: string; // dubled-games-swiper veya dubbed-anime-swiper
  dubRequestLink?: string; // Opsiyonel dublaj isteği linki
}

export default function DubbedGamesSection({ title, totalCount, items, swiperClassName, dubRequestLink = "#" }: DubbedSectionProps) {
